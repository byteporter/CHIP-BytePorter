...
m4_forloop(`i', `1', m4_defn(`__OVERLAY_CNT'), `setexpr __overlay(i)_addr_r $fdt_addr_r + m4_format(`0x%x', m4_eval(`(('i`-1) * 0x1000) + 0xf000'))
')`'m4_dnl
...
m4_forloop(`i', `1', m4_defn(`__OVERLAY_CNT'), `ext4load mmc 1:1 $`'__overlay(i)_addr_r /dtbo/__overlay(i).dtbo
')`'m4_dnl

fdt addr $fdt_addr_r
fdt resize m4_format(`0x%x',m4_eval(`('__OVERLAY_CNT` + 1) * 0x1000'))
m4_forloop(`i', `1', m4_defn(`__OVERLAY_CNT'), `fdt apply $`'__overlay(i)_addr_r
')`'m4_dnl
